package ThomasonIIIContigFilter::ThomasonIIIContigFilterServer;
...
sub get_service_name
{
    ...
    if(!defined $ENV{$SERVICE}) {
        return 'ThomasonIIIContigFilter';
    }
    return $ENV{$SERVICE};
}
...
sub call_method {
    ...
    my $ctx = ThomasonIIIContigFilter::ThomasonIIIContigFilterServerContext->new($self->{loggers}->{userlog},
    ...
    # Service ThomasonIIIContigFilter does not require authentication.
    ...
    my @result;
    {
        ...
        my $stderr = ThomasonIIIContigFilter::ThomasonIIIContigFilterServerStderrWrapper->new($ctx, $get_time);
        $ctx->stderr($stderr);
...
sub get_method
{
    ...
    {
	$self->exception('NoSuchMethod',
			 "'$method' is not a valid method in service ThomasonIIIContigFilter.");
    }
...
package ThomasonIIIContigFilter::ThomasonIIIContigFilterServerContext;

use strict;

=head1 NAME

ThomasonIIIContigFilter::ThomasonIIIContigFilterServerContext
...
package ThomasonIIIContigFilter::ThomasonIIIContigFilterServerStderrWrapper;
...
unless (caller) {
    ...
    my $server = ThomasonIIIContigFilter::ThomasonIIIContigFilterServer->new(

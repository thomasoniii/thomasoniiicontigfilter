SERVICE = thomasoniiicontigfilter
SERVICE_CAPS = ThomasonIIIContigFilter
SPEC_FILE = ThomasonIIIContigFilter.spec
URL = https://kbase.us/services/thomasoniiicontigfilter
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
